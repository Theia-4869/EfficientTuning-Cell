...
def create_dataload(args, num_aug_splits, data_config):
    ...
    if mixup_active:
        ...
        print("8888888888888888888888888888888888 NO mixup cutmix 88888888888888888888888888888888888888888")
...
def main(args_input = None):
    ...
    if args.pruning:
        if args.pruning_method == 'gradient_perCell':
            ...
            mask = prune_by_percentile_gradient_perCell(model, mask, args.times_para)
    else:
        mask = None
